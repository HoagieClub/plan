					...
					<div className='py-24 sm:py-32 lg:pb-40'>
						<div className='mx-auto max-w-7xl px-6 lg:px-8'>
							<div className='mx-auto max-w-2xl text-center'>
								...
								{/* Email Section */}
								<div className='mt-12'>
									<h2 className='mb-4 text-3xl font-bold text-black'>Email Us</h2>
									<a
										href='mailto:hoagie@princeton.edu'
										className='mt-2 block text-lg text-blue-600 hover:text-blue-700'
									>
								...
								{/* Bug Report Section */}
								<div className='mt-12'>
									<h2 className='mb-4 text-3xl font-bold text-black'>Report a Bug</h2>
