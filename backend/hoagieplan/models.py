...
class GradingInfo(models.Model):
    ...
    grading_final_exam = models.IntegerField(null=True, blank=True)
    grading_mid_exam = models.IntegerField(null=True, blank=True)
    grading_home_final_exam = models.IntegerField(null=True, blank=True)
    grading_home_mid_exam = models.IntegerField(null=True, blank=True)
    grading_paper_final_exam = models.IntegerField(null=True, blank=True)
    grading_paper_mid_exam = models.IntegerField(null=True, blank=True)
    grading_other_exam = models.IntegerField(null=True, blank=True)
    grading_oral_pres = models.IntegerField(null=True, blank=True)
    grading_quizzes = models.IntegerField(null=True, blank=True)
    grading_lab_reports = models.IntegerField(null=True, blank=True)
    grading_papers = models.IntegerField(null=True, blank=True)
    grading_prob_sets = models.IntegerField(null=True, blank=True)
    grading_prog_assign = models.IntegerField(null=True, blank=True)
    grading_precept_part = models.IntegerField(null=True, blank=True)
    grading_term_papers = models.IntegerField(null=True, blank=True)
    grading_design_projects = models.IntegerField(null=True, blank=True)
    grading_other = models.IntegerField(null=True, blank=True)
